from ai.ai_models.share import *
import ai.ai_models.config
...
from ai.ai_models.annotator.util import resize_image, HWC3
from ai.ai_models.cldm.model import create_model, load_state_dict
from ai.ai_models.cldm.ddim_hacked import DDIMSampler
...
class MainControlNet:
    ...
    def load_model(self):
        self.model = create_model("ai/ai_models/models/cldm_v15.yaml").cpu()
        self.model.load_state_dict(
            load_state_dict("ai/ai_models/models/control_sd15_scribble.pth", location="cuda")
        )
